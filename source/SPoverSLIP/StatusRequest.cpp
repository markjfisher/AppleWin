...
StatusRequest::StatusRequest(const uint8_t request_sequence_number, const uint8_t sp_unit, const uint8_t status_code) : Request(request_sequence_number, SP_STATUS, sp_unit), status_code_(status_code)
{
}
