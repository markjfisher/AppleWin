                ...
                if (ImGui::BeginTabItem("Network"))
                {
                    if (ImGui::BeginTabBar("SmartPort"))
                    {
                        ...
                        if (ImGui::Checkbox("Run Listener at startup", &startSPListener))
                        {
                            ...
                            REGSAVE(REGVALUE_START_SP_SLIP_LISTENER, startSPListener ? 1 : 0);
                        }
                        ...
                        if (ImGui::InputText(
                                "Listener Address", ipAddress, IM_ARRAYSIZE(ipAddress),
                                ImGuiInputTextFlags_EnterReturnsTrue))
                        {
                            ...
                            if (fixedAddress != old_address)
                            {
                                ...
                                RegSaveString(REG_CONFIG, REGVALUE_SP_LISTENER_ADDRESS, 1, fixedAddress);
                            }
                        }
                        ...
                        if (ImGui::InputText(
                                "Listener Port", ipPort, IM_ARRAYSIZE(ipPort), ImGuiInputTextFlags_EnterReturnsTrue))
                        {
                            ...
                            if (port != old_port)
                            {
                                ...
                                REGSAVE(REGVALUE_SP_LISTENER_PORT, port);
                            }
                        }
                        ...
                        std::strncpy(
                            responseTimeout, std::to_string(listener.get_response_timeout()).c_str(),
                            sizeof(responseTimeout));
                        responseTimeout[sizeof(responseTimeout) - 1] = '\0';
                        if (ImGui::InputText(
                                "Response Timeout", responseTimeout, IM_ARRAYSIZE(responseTimeout),
                                ImGuiInputTextFlags_EnterReturnsTrue))
                        {
                            ...
                            if (rto != old_response_timeout)
                            {
                                ...
                                REGSAVE(REGVALUE_SP_RESPONSE_TIMEOUT, rto);
                            }
                        }
